    ...
    <>
      ...
      <View style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <Text style={styles.heading}>Add Students</Text>
          <Text style={styles.description}>
            Add students to your class and manage their details.
          </Text>
          ...
          <View style={styles.content}>
            ...
            <Text style={styles.infoText}>
              Start adding students to manage their records, attendance, and
              progress seamlessly.
            </Text>
          </View>
        </ScrollView>
